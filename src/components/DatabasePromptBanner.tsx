...
import { Database, FolderOpen, PlusCircle, ShieldCheck } from 'lucide-react';
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
        <div className="space-y-2 max-w-2xl">
          ...
          <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            La aplicación funciona con un archivo único portátil (ej:{' '}
            <code className="text-amber-300 font-mono bg-slate-800 px-1.5 py-0.5 rounded">
              inventario.json
            </code>
            ). Todos tus productos, movimientos e instalaciones se leerán y guardarán
            automáticamente en ese archivo, listo para tu pendrive.
          </p>
        </div>
